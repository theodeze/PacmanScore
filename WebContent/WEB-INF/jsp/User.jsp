          ...
          <strong>Attention</strong> <c:out value = "${Warning}"/> <c:remove var="Warning" scope="session" />
			...
			<form id="divUser" class="form-signin border border-info" method="post" v-if=v2_account>
				<div class="form-label-group">
					<input type="text" id=email_connexion name="Identifiant_connexion" class="form-control" required>
					<label for="email_connexion">Email</label>
				</div>
				<div class="form-label-group">
					<input type="password" id="mdp_connexion" name="MotDePasse_connexion" class="form-control" required>
			...
			<form id="User" class="form-signin border border-info" v-on:submit.prevent="validateBeforeSubmit()" method="post" v-if=v1_account>
				...
				<div class="form-label-group">
					<input type="text" id="email_inscription" name="Pseudo_inscription" class="form-control" required>
					<label for="pseudo_inscription">Pseudo</label>
				</div>

				<div class="form-label-group">
					<input v-validate="'required'" id="pwd_inscription" name="MotDePasse_inscription" type="password" class="form-control" data-vv-as="mot de passe"
					 ref="password" required>
					<label for="pwd_inscription">Mot de Passe</label>
				</div>

				<div class="form-label-group">
					<input v-validate="'required|confirmed:password'" id="pwd_inscription_conf" name="MotDePasse_inscription_confirmation" type="password" class="form-control"
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-4 pt-2 text-center">
					...
					<form id="ModifMDP" class="form-signin" v-on:submit.prevent="validateBeforeSubmit()" method="post">
						...
						<div class="form-label-group">
							<input type="password" id="old_mdp" name="old_MotDePasse_modif_mdp" class="form-control" required>
							<label for="old_mdp_modif_mdp">Ancien Mot de passe</label>
						</div>
						<div class="form-label-group">
							<input v-validate="'required'" id="pwd_modif_mdp" name="MotDePasse_modif_mdp" type="password" class="form-control" data-vv-as="votre nouveau mot de passe"
							 ref="password" required>
							<label for="pwd_modif_mdp">Nouveau Mot de Passe</label>
						</div>

						<div class="form-label-group">
							<input v-validate="'required|confirmed:password'" id="pwd_modif_mdp_confirm" name="MotDePasse_modif_mdp_confirm" type="password"
				...
				<div class="col-md-4 pt-2 text-center">
					...
					<form id="ModifEmail" class="form-signin" method="post">
						<div class="form-label-group">
							<input type="text" id="old_email_modif_email" name="Old_Identifiant_modif_email" class="form-control" required>
							<label for="old_email_modif_email">Ancien Email</label>
						</div>
						<div class="form-label-group">
							<input type="text" id="email_mofi_email" name="Identifiant_modif_email" class="form-control" required>
							<label for="email_modif_email">Email</label>
						</div>

						<div class="form-label-group">
							<input type="password" id="mdp_modif_email" name="MotDePasse_modif_email" class="form-control" required>
				...
				<div class="col-md-4 pt-2 text-center">
					...
					<form id="ModifPseudo" class="form-signin" method="post">
						<div class="form-label-group">
							<input type="text" id="old_email_modif_pseudo" name="Identifiant_modif_pseudo" class="form-control" required>
							<label for="pseudo_modif_email">Nouveau Pseudo</label>
						</div>
						<div class="form-label-group">
							<input type="text" id="email_modif_pseudo" name="Identifiant_modif_pseudo" class="form-control" required>
							<label for="email_modif_pseudo">Email</label>
						</div>

						<div class="form-label-group">
							<input type="password" id="mdp_modif_pseudo" name="MotDePasse_modif_pseudo" class="form-control" required>
			...
			<div class="modal-content">
				...
				<form id="suppr_compte" class="form-signin" method="post">
					<div class="modal-body">
						...
						<div class="form-label-group">
							<input type="text" id="email_suppr" name="Identifiant_suppr" class="form-control" required>
